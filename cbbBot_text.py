...
def index_thread(games):
    games['order'] = 3
    tv = ['ESPN', 'ESPN2', 'ESPNU', 'ESPNN', 'ACCN', 'SECN', 'FS1', 'FS2', 'ABC', 'BTN', 'CBSSN', 'FOX', 'CBS', 'PAC12', 'NBC', 'TBS', 'TNT', 'truTV', 'USA Net', 'CW NETWORK']
